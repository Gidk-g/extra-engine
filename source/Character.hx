...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		antialiasing = Prefs.globalAntialiasing;
		...
		switch (curCharacter)
		{
			...
			case 'tankman':
				...
				animation.addByPrefix('prettyGoodAnim', 'PRETTY GOOD tankman instance 1', 24);
				...
				addOffset('idle');
				addOffset("singUP", 42, 53);
				addOffset("oldSingUP", 42, 53);
			...
			case 'bf-holding-gf-DEAD':
				...
				addOffset('firstDeath');
				addOffset('deathLoop', 0, -17);
				addOffset('deathConfirm', 0, 14);
				barColor = FlxColor.fromRGB(49, 176, 209);
				playAnim('firstDeath');
			...
			default:
				...
				if(!Prefs.globalAntialiasing) antialiasing = false;
	...
	{
		var offset:Array<String> = CoolUtil.coolTextFile(Paths.txtImage('characters/' + character + "Offsets", library));
